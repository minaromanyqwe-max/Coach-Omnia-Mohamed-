...
<Link href="/chick" className="bg-gradient-to-r from-[#00c6ff] to-[#7b2ff7] text-white hover:opacity-90 transition-all duration-200 shadow-[0_0_15px_rgba(0,198,255,0.4)] active:scale-95 text-sm font-bold px-5 py-2.5 rounded-xl block text-center">
  Subscribe Now
</Link>
</div>          </MobileNavMenu>
        </MobileNav>
